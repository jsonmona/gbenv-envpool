...
## Temporary notice
To build this source code, you may need to do following in addition to what the offical documention says:
1. export USE_BAZEL_VERSION=6.5.0
2. If you encounter an error with 'Lorem ipsum.txt' not found, create a empty file with that path.
